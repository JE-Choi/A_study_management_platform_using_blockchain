...
// 한 트랜잭션 정보
class AttendanceCheckItem extends Component {
  state = {
    destination: '삭제된 스터디',
    startingPoint:'',
            ...
            {this.state.data ? 
              <div className="add_schedule_detail">
                  <ul className="list-group list-group-horizontal txn_content">
                    ...
                    <li className="list-group-item detail_txns study_item">출석체크<br/>(in Study Group)</li>
...
export default AttendanceCheckItem;
