    ...
    return (
        <div className="mainPageBackgroundColor">
          <div className="all_list_frame">
            ...
            <input type="button" style = {isLoginShow} className="btn btn-outline-primary btn-lg btn-block " id="moveBtn_study_make" value="STUDY 생성"/>
            </Link>
          ...
          <div className="out_frame_not_exist_studyItem">
            ...
            함께 공부할 스터디를 생성해주세요.
            <br />
            <span id="login_emphasis">로그인</span> 후, 
            <span id="creation_emphasis">STUDY 생성 버튼</span>을 누르면 스터디가 생성됩니다.
            <br />
            <br />
